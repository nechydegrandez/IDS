...
class CifrasEnLetras {
  ...
  */
  public static function convertirLempirasEnLetras($lempiras, $numeroDecimales=2) {
    return self::convertirNumeroEnLetras($lempiras, $numeroDecimales,
      "Lempira", "Lempiras", false, "Centavo", "Centavos", false);
  }
